            ...
            <tbody>
                <?php
                    ...
                    foreach ($categories as $categorie){
                        ...
                        <th scope="row">'.$i.'</th>
                        <td>'.$categorie['nom'].'</td>
                        <td>'.$categorie['déscriptions'].'</td>
                        <td>
                        <a  data-bs-toggle="modal" data-bs-target="#editModal'.$categorie['id'].'" class="btn btn-success">Modifier</a>
                        <a href="supprimer.php?idc='.$categorie['id'].'" class="btn btn-danger">Supprimer</a>
              ...
              <div class="modal-body">
                <form action="modifier.php" method="post">
                  <input type="hidden" value="<?php echo $categorie['id']; ?>" name="idc">
                    ...
                    <div class="form-group">
                        <textarea name="description" class="form-control" placeholder="description de categorie ..."><?php echo $categorie['déscriptions'];?></textarea>
                    </div>
